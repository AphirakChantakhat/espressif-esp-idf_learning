...
#define GPIO_INPUT_PIN_POLL_SEL (1ULL<<GPIO_INPUT_IO_2)
...
void app_main(void)
{
    ...
    gpio_evt_queue = xQueueCreate(10, sixeof(uint32_t));
    ...
    for (;;)
    {
        ...
        gpio_set_leval(GPIO_OUTPUT_IO_0, cnt & 0x01);
        gpio_set_leval(GPIO_OUTPUT_IO_1, cnt & 0x02);
